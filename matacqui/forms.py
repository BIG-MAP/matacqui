...
class ContactDetails(mincepy.SimpleSavable):
    ...
    name = mincepy.field('name')
    email = mincepy.field('email')
    institution = mincepy.field('institution')
    address = mincepy.field('address')
    task = mincepy.field('task')
    work_package = mincepy.field('work_package')
...
class OrderDetails(mincepy.SimpleSavable):
    ...
    component = mincepy.field('component')
    category = mincepy.field('category')
    subcategory = mincepy.field('subcategory')
    specifications = mincepy.field('specifications')
    amounts = mincepy.field('amounts')

    def get_html(self) -> str:
        lines = [
            '<p><u>Item</u>',
            self.component + ' : ' + self.category + ' : ' + self.subcategory,
            '</p>'
...
form_data_schema = {'Anode':
                        {'Graphite':
                             {'powder':
                                  {'properties': {'ID': '', 'Supplier': 'Ciditec', 'Contact': 'Elixabete Ayerbe',
                                                  'Contact Email': 'eayerbe@cidetec.es'},
                                   'input': {'Quantity M3-12 [g]': 0, 'Quantity M13-24 [g]': 0,
                                             'Quantity M25-36 [g]': 0}},
                              'electrode':
                                  {'properties': {'ID': '', 'Supplier': 'Ciditec', 'Contact': 'Elixabete Ayerbe',
                                                  'Contact Email': 'eayerbe@cidetec.es'},
                                   'input': {'Sheet area M3-12 [cm^2]': 0, 'Sheet area M13-24 [cm^2]': 0,
                                             'Sheet area M25-36 [cm^2]': 0, 'Thickness [um]': 0,
                                             'Loading [mAh/cm^2]': 0}}},
                         'Silicon':
                             {'powder':
                                  {'properties': {'ID': '', 'Supplier': 'Ciditec', 'Contact': 'Elixabete Ayerbe',
                         ...
                         'Silicon/graphite':
                             {'powder':
                              ...
                              'electrode':
                                  {'properties': {'ID': '', 'Supplier': 'Ciditec', 'Contact': 'Elixabete Ayerbe',
                                                  'Contact Email': 'eayerbe@cidetec.es'},
                                   'input': {'Sheet area M13-12 [cm^2]': 0, 'Sheet area M13-24 [cm^2]': 0,
                                             'Sheet area M25-36 [cm^2]': 0, 'Thickness [um]': 0,
                                             'Loading [mAh/cm^2]': 0}},
                              'special':
                                  {'properties': {'ID': '', 'Supplier': 'Ciditec', 'Contact': 'Elixabete Ayerbe',
                         ...
                         'Lithium metal':
                             {'sheet':
                                  {'properties': {'ID': '', 'Supplier': 'HONJO'},
                                   'input': {'Sheet area [cm^2]': 0}}}
                         },

                    'Cathode':
                        {'NMC811':
                             {'powder':
                                  {'properties': {'ID': '', 'Supplier': 'Umicore', 'Contact': 'Jeremie Auvergniot',
                         ...
                         'LiNiO2':
                             {'powder':
                                  {'properties': {'ID': '', 'Supplier': 'BASF', 'Contact': 'Pascal Hartmann',
                                                  'Contact Email': 'pascal.hartmann@basf.com'},
                                   'input': {'Quantity M3-12 [g]': 0, 'Quantity M13-24 [g]': 0,
                                             'Quantity M25-36 [g]': 0}},
                              'electrode':
                                  {'properties': {'ID': '', 'Standard': '0.5 m^2 single side coating',
                                                  'Supplier': 'BASF', 'Contact': 'Pascal Hartmann',
                                                  'Contact Email': 'pascal.hartmann@basf.com'},
                                   'input': {'Sheet area M3-12 [cm^2]': 0, 'Sheet area M13-24 [cm^2]': 0,
                         ...
                         'LNMO':
                             {'powder':
                              ...
                              'special request':
                                  {'properties': {'ID': '', 'Supplier': 'BASF', 'Contact': 'Pascal Hartmann',
                                                  'Contact Email': 'pascal.hartmann@basf.com'},
                                   'input': {'Request': '', 'Amount [units]': ''}}}
                         },

                    'Electrolyte':
                        {'Formulation':
                             {'LP30':
                                  {'properties': {'ID': '', 'Purity': 'Battery grade', 'Water content': '< 20 ppm'},
                                   'input': {'Quantity [L]': [1]}},
                              'LP37':
                                  {'properties': {'ID': '', 'Purity': 'Battery grade', 'Water content': '< 20 ppm'},
                                   'input': {'Quantity [L]': [1]}},
                         ...
                         'Component':
                             {'LiPF6':
                                  {'properties': {'ID': '', 'Purity': 'Battery grade', 'Water content': '< 20 ppm'},
                                   'input': {'Quantity [g]': [50, 500]}},
                              'LiTFSI':
                                  {'properties': {'ID': '', 'Purity': 'Battery grade', 'Water content': '< 20 ppm',
                                                  'Supplier': 'Solvay', 'Contact': 'Marc-David Braida',
                         ...
                         'Fluorinated solvent':
                             {'solvent':
                                  {'properties': {'ID': '', 'Supplier': 'Solvay'},
                                   'input': {'Request': '', 'Volume [L]': [1]}}}
                         },

                    'Separator':
                        {'Celgard 2500':
                             {'Porosity 53%':
                                  {'properties': {'ID': '', 'Thickness': '25 um', 'Porosity': '53%',
                                                  'Order contact': 'Mario Giovagnoli'},
                                   'input': {'Sheet area [cm^2]': 0}}},
                         'Other':
                             {'Special request':
                                  {'properties': {'ID': ''},
                                   'input': {'Request': '', 'Sheet area [cm^2]': 0}}}
...
class ContactInfoSubapp:
    ...
    def __build_widgetbox_left(self):
        ...
        self.widget['Text_Email'] = wdg.Text(value='', placeholder='john.smith@dtu.dk', description='Email')
        self.widget['Text_Address'] = wdg.Text(value='', placeholder='Long street 1, 0000 City, Country',
                                               description='Address')
    ...
    def __build_widgetbox_right(self):
        ...
        self.widget['Text_Task'] = wdg.Text(value='', placeholder='C-rate tests', description='Task')
        self.widget['Text_Wp'] = wdg.Dropdown(options=['WP{}'.format(str(i + 1)) for i in range(11)],
                                              description='Work package', style={'description_width': 'initial'})
    ...
    def __assemble_interface(self):
        ...
        self.interface = wdg.VBox([self.widget['Title'], wdg.HBox([self.widget_box['left'], self.widget_box['right']])])
    ...
    def are_user_inputs_ok(self):
        ...
        elif not self.widget['Text_Email'].value.strip() or self.widget['Text_Email'].value.strip().find('@') == -1:
    ...
    def get_contact_details(self) -> ContactDetails:
        ...
        return ContactDetails(
            name=self.widget['Text_Name'].value,
...
class SelectOrderSubapp:
    ...
    def __build_widgetbox_selection(self):
        ...
        self.widget['Dropdown_category'] = wdg.Dropdown(options=self.am[self.widget['Toggle_components'].value].keys(),
                                                        description='Category')
        self.widget['Dropdown_subcategory'] = wdg.Dropdown(
            options=self.am[self.widget['Toggle_components'].value][self.widget['Dropdown_category'].value].keys(),
            description='Subcategory')
        self.widget_box['selection'] = wdg.VBox(
            [self.widget['Toggle_components'], self.widget['Dropdown_category'], self.widget['Dropdown_subcategory']])

    def __build_widgetbox_amounts_container(self):
        self.widget['HTML_matinfo'] = wdg.HTML()
        self.widget['Output_amount'] = wdg.Output()
        self.widget_box['amounts'] = wdg.VBox([self.widget['HTML_matinfo'], self.widget['Output_amount']])

    # ---------- interface ---------
    def __assemble_interface(self):
        self.widget['Title'] = wdg.HTML(value='<h2>Select Material</h2>')
        self.interface = wdg.VBox([self.widget['Title'], self.widget_box['selection'], self.widget_box['amounts']])
    ...
    def render_dynamic_widgetbox_amounts(self):
        ...
        for input_key, input_value in self.am[component][category][subcategory]['input'].items():
            if isinstance(input_value, int):
                self.widget['Dynamic'][input_key] = wdg.BoundedIntText(value=input_value, description=input_key, min=0,
                                                                       max=1000, style={'description_width': 'initial'})
            elif isinstance(input_value, str):
                self.widget['Dynamic'][input_key] = wdg.Textarea(description=input_key, value='',
                                                                 placeholder='Describe your request',
                                                                 style={'description_width': 'initial'})
            elif isinstance(input_value, list):
                self.widget['Dynamic'][input_key] = wdg.Dropdown(description=input_key, options=input_value,
                                                                 value=input_value[0],
                                                                 style={'description_width': 'initial'})
    ...
    def update_category(self):
        self.widget['Dropdown_category'].options = self.am[self.widget['Toggle_components'].value].keys()

    def update_subcategory(self):
        self.widget['Dropdown_subcategory'].options = self.am[self.widget['Toggle_components'].value][
            self.widget['Dropdown_category'].value].keys()
    ...
    def get_input_fields(self) -> OrderDetails:
        ...
        order_details = OrderDetails(
            ...
            specifications={key: value
                            for key, value in
                            self.am[component][category][subcategory]['properties'].items()},
            amounts={key: self.widget['Dynamic'][key].value for key in self.widget['Dynamic'].keys()}
        )
...
class SubmitOrderSubapp:
    ...
    def __build_widgetbox_order(self):
        ...
        self.widget['Button_submit'] = wdg.Button(description='Submit order', icon='server', disabled=True,
                                                  button_style='info')
    ...
    def __assemble_interface(self):
        ...
        self.interface = wdg.VBox(
            [self.widget['Title'], self.widget['Button_prepare'], self.widget['HTML_error'], self.widget['HTML_review'],
             self.widget['Button_submit']])
...
class MaterialsAcquisitionForm:
    ...
    def __assemble_app(self):
        self.interface = wdg.VBox(
            [self.subapp_contact.interface, self.subapp_selection.interface, self.subapp_submission.interface])

    def __widget_events(self):
        self.subapp_selection.widget['Toggle_components'].observe(self.callback_select_component, names='value')
        self.subapp_selection.widget['Dropdown_category'].observe(self.callback_select_category, names='value')
        self.subapp_selection.widget['Dropdown_subcategory'].observe(self.callback_select_subcategory, names='value')
    ...
    def callback_submit_order(self, _):
        ...
        order_details = self.subapp_selection.get_input_fields()
        order = MaterialsOrder(contact_details, order_details)
        print("Order would be saved to database")


MINCEPY_TYPES = (MaterialsOrder,)
